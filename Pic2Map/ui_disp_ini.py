...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.labelDEM = QtWidgets.QLabel(Dialog)
        ...
        self.groupBox2.setStyleSheet("QGroupBox{padding-top:15px; margin-top:-15px}")
        ...
        self.gridLayout3.addWidget(self.toolButtonDEM, 0, 1, 1, 1)
        self.pushButtonDEM = QtWidgets.QPushButton(Dialog)
        self.pushButtonDEM.setObjectName("PushButtonDEM")
        self.gridLayout3.addWidget(self.pushButtonDEM, 0, 0, 1, 1)
        self.gridLayout.addWidget(self.groupBox2, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.toolButton_2, 4, 3, 1, 1)
